...
var eg, tg, Ea, Aa, Li, rg, Pa, Ra, ig, sg, ng, Oa = de(() => {
...
var Cr, Ya, Ui, og, Wi, ag, lg, ug, Vi, cg, za, hg, pg, dg, Ka, Xa, Gi, Qa, fg, Ar, Ga, Ua, Za = de(() => {
  Cr = require("node:events"), Ya = require("node:stream"), Ui = require("node:stream/promises");
  n(Yi, "mergeStreams");
  og = /* @__PURE__ */ n((t, e) => {
    if (t.length === 0)
      return 16384;
    ...
    for await (let [i] of (0, Cr.on)(t, "unpipe", { signal: r }))
      e.has(i) && i.emit(Ka);
  ...
  signal: o } }) => {
    ...
    await (0, Cr.once)(t, Ka, { signal: s }), e.delete(t), r.delete(t), i.delete(t);
...
var el = f((Tr) => {
  ...
  Tr.isEnoentCodeError = void 0;
  function yg(t) {
    return t.code === "ENOENT";
  }
  n(yg, "isEnoentCodeError");
  Tr.isEnoentCodeError = yg;
});
...
var tl = f((Or) => {
  ...
  Or.createDirentFromStats = void 0;
  var zi = class {
    static {
...
var Dr = f((fe) => {
  ...
  fe.encloseBrace = (t) => t.type !== "brace" ? !1 : t.commas >> 0 + t.ranges >> 0 === 0 ? (t.invalid = !0, !0) : !1;
  fe.isInvalidBrace = (t) => t.type !== "brace" ? !1 : t.invalid === !0 || t.dollar ? !0 : t.commas >> 0 + t.ranges >> 0 === 0 || t.open !==
...
var ts = f((sR, Il) => {
  ...
  (t, e, r) => {
    ...
    return t.positives.length && (s = t.positives.map((l) => $r(String(l), r)).join("|")), t.negatives.length && (o = `-(${i}${t.negatives.map(
    (l) => $r(String(l), r)).join("|")})`), s && o ? a = `${s}|${o}` : a = s || o, e.wrap ? `(${i}${a})` : a;
...
var Nl = f((oR, $l) => {
  "use strict";
  var ey = ts(), kl = Dr(), ty = /* @__PURE__ */ n((t, e = {}) => {
    let r = /* @__PURE__ */ n((i, s = {}) => {
...
var jl = f((lR, ql) => {
  "use strict";
  var ry = ts(), Ml = Ir(), Et = Dr(), pt = /* @__PURE__ */ n((t = "", e = "", r = !1) => {
    let i = [];
    ...
    let r = e.rangeLimit === void 0 ? 1e3 : e.rangeLimit, i = /* @__PURE__ */ n((s, o = {}) => {
      ...
      if (s.nodes && s.ranges > 0) {
        ...
        let p = ry(...m, e);
        p.length === 0 && (p = Ml(s, e)), l.push(pt(l.pop(), p)), s.nodes = [];
        return;
      }
...
var zl = f((dR, Yl) => {
  "use strict";
  var Ul = Ir(), yy = Nl(), xy = jl(), by = Gl(), ce = /* @__PURE__ */ n((t, e = {}) => {
    let r = [];
    if (Array.isArray(t))
      for (let i of t) {
        let s = ce.create(i, e);
...
var zt = f((mR, Jl) => {
  "use strict";
  var _y = require("path"), Te = "\\\\/", Kl = `[^${Te}]`, Le = "\\.", vy = "\\+", Sy = "\\?", Nr = "\\/", wy = "(?=.)", Xl = "[^/]", is = `\
(?:${Nr}|$)`, Ql = `(?:^|${Nr})`, ss = `${Le}{1,2}${is}`, Ey = `(?!${Le})`, Py = `(?!${Ql}${ss})`, Ry = `(?!${Le}{0,1}${is})`, Ay = `(?!${ss}\
)`, Cy = `[^.${Nr}]`, Ty = `${Xl}*?`, Zl = {
    DOT_LITERAL: Le,
    PLUS_LITERAL: vy,
    QMARK_LITERAL: Sy,
    ...
    QMARK: Kl,
    STAR: `${Kl}*?`,
    DOTS_SLASH: `${Le}{1,2}(?:[${Te}]|$)`,
    NO_DOT: `(?!${Le})`,
    NO_DOTS: `(?!(?:^|[${Te}])${Le}{1,2}(?:[${Te}]|$))`,
    NO_DOT_SLASH: `(?!${Le}{0,1}(?:[${Te}]|$))`,
    NO_DOTS_SLASH: `(?!${Le}{1,2}(?:[${Te}]|$))`,
    QMARK_NO_DOT: `[^.${Te}]`,
    START_ANCHOR: `(?:^|[${Te}])`,
    END_ANCHOR: `(?:[${Te}]|$)`
  }, Dy = {
...
var au = f((yR, ou) => {
  ...
  var eu = Kt(), {
    ...
    w = !1, g = !1, _ = !1, P = !1, E = !1, k = !1, T = !1, G = !1, A = !1, $ = 0, O, C, M = { value: "", depth: 0, isGlob: !1 }, J = /* @__PURE__ */ n(
    () => c >= i, "eos"), b = /* @__PURE__ */ n(() => u.charCodeAt(c + 1), "peek"), V = /* @__PURE__ */ n(() => (O = C, u.charCodeAt(++c)), "\
advance");
    for (; c < i; ) {
      C = V();
      let ie;
      if (C === Xt) {
        k = M.backslashes = !0, C = V(), C === ls && (E = !0);
        continue;
      }
      if (E === !0 || C === ls) {
        for ($++; J() !== !0 && (C = V()); ) {
          ...
          if (E !== !0 && C === os && (C = V()) === os) {
            if (p = M.isBrace = !0, g = M.isGlob = !0, A = !0, s === !0)
              continue;
            break;
          }
          if (E !== !0 && C === Ly) {
      ...
      if (r.noext !== !0 && (C === Hy || C === jy || C === ns || C === tu || C === as) === !0 && b() === us) {
        if (g = M.isGlob = !0, _ = M.isExtglob = !0, A = !0, C === as && c === h && (G = !0), s === !0) {
          for (; J() !== !0 && (C = V()); ) {
            if (C === Xt) {
      ...
      if (C === ns) {
        if (O === ns && (P = M.isGlobstar = !0), g = M.isGlob = !0, A = !0, s === !0)
          continue;
        break;
      }
      if (C === tu) {
        if (g = M.isGlob = !0, A = !0, s === !0)
          continue;
        break;
      }
      if (C === Fy) {
        for (; J() !== !0 && (ie = V()); ) {
          ...
          if (ie === Wy) {
            w = M.isBracket = !0, g = M.isGlob = !0, A = !0;
            break;
          }
        }
        if (s === !0)
    ...
    y = u) : H = u, H && H !== "" && H !== "/" && H !== u && iu(H.charCodeAt(H.length - 1)) && (H = H.slice(0, -1)), r.unescape === !0 && (y &&
    (y = eu.removeBackslashes(y)), H && k === !0 && (H = eu.removeBackslashes(H)));
    let x = {
      prefix: Ke,
      input: t,
      start: h,
    ...
    if (r.tokens === !0 && (x.maxDepth = 0, iu(C) || a.push(M), x.tokens = a), r.parts === !0 || r.tokens === !0) {
      let ie;
      for (let N = 0; N < o.length; N++) {
        let Ae = ie ? ie + 1 : h, Ce = o[N], ue = t.slice(Ae, Ce);
        r.tokens && (N === 0 && h !== 0 ? (a[N].isPrefix = !0, a[N].value = Ke) : a[N].value = ue, su(a[N]), x.maxDepth += a[N].depth), (N !==
        0 || ue !== "") && l.push(ue), ie = Ce;
      }
      if (ie && ie + 1 < t.length) {
        let N = t.slice(ie + 1);
        l.push(N), r.tokens && (a[a.length - 1].value = N, su(a[a.length - 1]), x.maxDepth += a[a.length - 1].depth);
      }
...
var cu = f((bR, uu) => {
  ...
  var Mr = zt(), he = Kt(), {
    ...
    return r;
  }, "expandRange"), Pt = /* @__PURE__ */ n((t, e) => `Missing ${t}: "${e}" - use "\\\\${e}" to match literal characters`, "syntaxError"), cs = /* @__PURE__ */ n(
  (t, e) => {
    if (typeof t != "string")
      throw new TypeError("Expected a string");
    t = lu[t] || t;
    let r = { ...e }, i = typeof r.maxLength == "number" ? Math.min(qr, r.maxLength) : qr, s = t.length;
    if (s > i)
      throw new SyntaxError(`Input length: ${s}, exceeds maximum allowed length: ${i}`);
    let o = { type: "bos", value: "", output: r.prepend || "" }, a = [o], l = r.capture ? "" : "?:", u = he.isWindows(e), c = Mr.globChars(u),
    h = Mr.extglobChars(c), {
      DOT_LITERAL: m,
      PLUS_LITERAL: p,
      SLASH_LITERAL: w,
      ...
      STAR: A,
      START_ANCHOR: $
    } = c, O = /* @__PURE__ */ n((S) => `(${l}(?:(?!${$}${S.dot ? _ : m}).)*?)`, "globstar"), C = r.dot ? "" : P, M = r.dot ? T : G, J = r.bash ===
    !0 ? O(r) : A;
...
*", y.output = J, b.output += y.output);
      ...
      if (V.length && S.type !== "paren" && (V[V.length - 1].inner += S.value), (S.value || S.output) && xr(S), y && y.type === "text" && S.
      type === "text") {
        y.value += S.value, y.output = (y.output || "") + S.value;
        return;
      }
      S.prev = y, a.push(S), y = S;
    }, "push"), _r = /* @__PURE__ */ n((S, B) => {
      let v = { ...h[B], conditions: 1, inner: "" };
      v.prev = y, v.parens = b.parens, v.output = b.output;
      let D = (r.capture ? "(" : "") + v.open;
      br("parens"), I({ type: S, value: B, output: b.output ? "" : g }), I({ type: "paren", extglob: !0, value: Ae(), output: D }), V.push(v);
    }, "extglobOpen"), zm = /* @__PURE__ */ n((S) => {
      let B = S.close + (r.capture ? ")" : ""), v;
      if (S.type === "negate") {
        let D = J;
        if (S.inner && S.inner.length > 1 && S.inner.includes("/") && (D = O(r)), (D !== J || ie() || /^\)+$/.test(Ce())) && (B = S.close = `\
    ...
    if (r.fastpaths !== !1 && !/(^[*!]|[/()[\]{}"])/.test(t)) {
      let S = !1, B = t.replace(Yy, (v, D, U, se, Z, Ni) => se === "\\" ? (S = !0, v) : se === "?" ? D ? D + se + (Z ? T.repeat(Z.length) : "") :
      Ni === 0 ? M + (Z ? T.repeat(Z.length) : "") : T.repeat(U.length) : se === "." ? m.repeat(U.length) : se === "*" ? D ? D + se + (Z ? J :
      "") : J : D ? v : `\\${v}`);
      return S === !0 && (r.unescape === !0 ? B = B.replace(/\\/g, "") : B = B.replace(/\\+/g, (v) => v.length % 2 === 0 ? "\\\\" : v ? "\\" :
      "")), B === t && r.contains === !0 ? (b.output = t, b) : (b.output = he.wrapOutput(B, b, e), b);
    }
    for (; !ie(); ) {
      if (x = Ae(), x === "\0")
        continue;
      ...
      if (x === ",") {
        ...
        D && Ke[Ke.length - 1] === "braces" && (D.comma = !0, v = "|"), I({ type: "comma", value: x, output: v });
        continue;
      }
      if (x === "/") {
      ...
      if (y.type === "star") {
        ...
        let Z = b.braces > 0 && (v.type === "comma" || v.type === "brace"), Ni = V.length && (v.type === "pipe" || v.type === "paren");
        if (!U && v.type !== "paren" && !Z && !Ni) {
          I({ type: "star", value: x, output: "" });
          continue;
        }
        for (; S.slice(0, 3) === "/**"; ) {
        ...
        if (v.type === "bos" && ie()) {
          y.type = "globstar", y.value += x, y.output = O(r), b.output = y.output, b.globstar = !0, ue(x);
          continue;
        }
...
|${w}${vr})`, y.value += x, b.output += v.output + y.output, b.globstar = !0, ue(x + Ae()), I({ type: "slash", value: "/", output: "" });
        ...
        if (v.type === "bos" && S[0] === "/") {
          y.type = "globstar", y.value += x, y.output = `(?:^|${w}|${O(r)}${w})`, b.output = y.output, b.globstar = !0, ue(x + Ae()), I({ type: "\
slash", value: "/", output: "" });
          continue;
        }
      ...
      (b.output += k, y.output += k) : (b.output += C, y.output += C), N() !== "*" && (b.output += g, y.output += g)), I(B);
    }
    for (; b.brackets > 0; ) {
  ...
  cs.fastpaths = (t, e) => {
    ...
    let o = he.isWindows(e), {
      ...
      STAR: w,
      START_ANCHOR: g
    } = Mr.globChars(o), _ = r.dot ? m : h, P = r.dot ? p : h, E = r.capture ? "" : "?:", k = { negated: !1, prefix: "" }, T = r.bash === !0 ?
    ".*?" : w;
    r.capture && (T = `(${T})`);
    let G = /* @__PURE__ */ n((C) => C.noglobstar === !0 ? T : `(${E}(?:(?!${g}${C.dot ? c : a}).)*?)`, "globstar"), A = /* @__PURE__ */ n((C) => {
      switch (C) {
        case "*":
          return `${_}${u}${T}`;
        case ".*":
        ...
        case "**":
          return _ + G(r);
        case "**/*":
          return `(?:${_}${G(r)}${l})?${P}${u}${T}`;
        case "**/*.*":
          return `(?:${_}${G(r)}${l})?${P}${T}${a}${u}${T}`;
        case "**/.*":
          return `(?:${_}${G(r)}${l})?${a}${u}${T}`;
        default: {
          let M = /^(.*?)\.(\w+)$/.exec(C);
          if (!M) return;
          let J = A(M[1]);
    ...
    }, "create"), $ = he.removePrefix(t, k), O = A($);
...
var _u = f((ER, bu) => {
  "use strict";
  var gu = require("util"), yu = zl(), Oe = fu(), ds = Kt(), mu = /* @__PURE__ */ n((t) => t === "" || t === "./", "isEmptyString"), xu = /* @__PURE__ */ n(
  (t) => {
    let e = t.indexOf("{");
    ...
    for (let h = 0; h < e.length; h++) {
      let m = Oe(String(e[h]), { ...r, onResult: l }, !0), p = m.state.negated || m.state.negatedExtglob;
      p && a++;
      for (let w of t) {
        let g = m(w, !0);
  ...
  W.match = W;
  W.matcher = (t, e) => Oe(t, e);
  W.isMatch = (t, e, r) => Oe(e, r)(t);
  W.any = W.isMatch;
  W.not = (t, e, r = {}) => {
  ...
  W.capture = (t, e, r) => {
    let i = ds.isWindows(r), o = Oe.makeRe(String(t), { ...r, capture: !0 }).exec(i ? ds.toPosixSlashes(e) : e);
    if (o)
      return o.slice(1).map((a) => a === void 0 ? "" : a);
  };
  W.makeRe = (...t) => Oe.makeRe(...t);
  W.scan = (...t) => Oe.scan(...t);
  W.parse = (t, e) => {
    let r = [];
...
var Ou = f((R) => {
  ...
  n(jr, "isNegativePattern");
  R.isNegativePattern = jr;
  function Pu(t) {
    return !jr(t);
  }
...
var Hu = f((re) => {
  ...
  var _e = Fe();
  function qx(t, e) {
    let r = ju(t, e), i = ju(e.ignore, e), s = Lu(r), o = Fu(r, i), a = s.filter((h) => _e.pattern.isStaticPattern(h, e)), l = s.filter((h) => _e.
  ...
  function gs(t, e, r) {
    let i = [], s = _e.pattern.getPatternsOutsideCurrentDirectory(t), o = _e.pattern.getPatternsInsideCurrentDirectory(t), a = ys(s), l = ys(
    o);
...
var Ps = f((Vr) => {
  ...
  var Wr = process.versions.node.split(".");
  if (Wr[0] === void 0 || Wr[1] === void 0)
    throw new Error(`Unexpected behavior. The 'process.versions.node' variable has invalid value: ${process.versions.node}`);
  var Ju = Number.parseInt(Wr[0], 10), Yx = Number.parseInt(Wr[1], 10), ec = 10, zx = 10, Kx = Ju > ec, Xx = Ju === ec && Yx >= zx;
  Vr.IS_SUPPORT_READDIR_WITH_FILE_TYPES = Kx || Xx;
});
...
var tc = f((Gr) => {
  ...
  Gr.createDirentFromStats = void 0;
  var Rs = class {
    static {
      n(this, "DirentFromStats");
    }
...
var ac = f((Je) => {
  ...
  var eb = dt(), rc = Zu(), tb = Ps(), ic = As(), sc = Cs();
  function rb(t, e, r) {
...
var fc = f((Ds) => {
  ...
  var lb = require("path"), ub = dt(), cb = dc(), Os = class {
    static {
      n(this, "Settings");
    }
    constructor(e = {}) {
...
var bc = f((fA, $s) => {
  ...
  function xc(t, e, r) {
    ...
    function _(A, $) {
      var O = i.get();
      O.context = t, O.release = E, O.value = A, O.callback = $ || me, O.errorHandler = l, a >= r || u.paused ? o ? (o.next = O, o = O) : (s =
      O, o = O, u.saturated()) : (a++, e.call(t, O.value, O.worked));
    }
    function P(A, $) {
      var O = i.get();
      O.context = t, O.release = E, O.value = A, O.callback = $ || me, O.errorHandler = l, a >= r || u.paused ? s ? (O.next = s, s = O) : (s =
      O, o = O, u.saturated()) : (a++, e.call(t, O.value, O.worked));
    }
    function E(A) {
      A && i.release(A);
      var $ = s;
      $ && a <= r ? u.paused ? a-- : (o === s && (o = null), s = $.next, $.next = null, e.call(t, $.value, $.worked), o === null && u.empty()) :
      --a === 0 && u.drain();
    }
    function k() {
  ...
  function gb() {
    ...
    this.worked = /* @__PURE__ */ n(function(r, i) {
      ...
      t.value = null, t.callback = me, t.errorHandler && o(r, a), s.call(t.context, r, i), t.release(t);
    }, "worked");
  }
  n(gb, "Task");
  function yb(t, e, r) {
...
var Fs = f((Ls) => {
  ...
  var wb = require("events"), Eb = Kr(), Pb = bc(), Qr = Xr(), Rb = qs(), js = class extends Rb.default {
    static {
      n(this, "AsyncReader");
    }
    constructor(e, r) {
    ...
    _handleError(e) {
      this._isDestroyed || !Qr.isFatalError(this._settings, e) || (this._isFatalError = !0, this._isDestroyed = !0, this._emitter.emit("erro\
r", e));
    }
    _handleEntry(e, r) {
      if (this._isDestroyed || this._isFatalError)
        return;
      let i = e.path;
      r !== void 0 && (e.path = Qr.joinPathSegments(r, e.name, this._settings.pathSegmentSeparator)), Qr.isAppliedFilter(this._settings.entryFilter,
      e) && this._emitEntry(e), e.dirent.isDirectory() && Qr.isAppliedFilter(this._settings.deepFilter, e) && this._pushToQueue(i, r === void 0 ?
      void 0 : e.path);
    }
    _emitEntry(e) {
...
var Sc = f((Us) => {
  ...
  var Ib = Kr(), Zr = Xr(), kb = qs(), Gs = class extends kb.default {
    static {
      n(this, "SyncReader");
    }
    constructor() {
    ...
    _handleError(e) {
      if (Zr.isFatalError(this._settings, e))
        throw e;
    }
    _handleEntry(e, r) {
      let i = e.path;
      ...
      e) && this._pushToStorage(e), e.dirent.isDirectory() && Zr.isAppliedFilter(this._settings.deepFilter, e) && this._pushToQueue(i, r ===
...
var Ec = f((Xs) => {
  ...
  var Nb = require("path"), Mb = Kr(), Ks = class {
    static {
      n(this, "Settings");
    }
    constructor(e = {}) {
...
var ei = f((Ie) => {
  ...
  function Lb(t, e, r) {
    if (typeof e == "function") {
      new Pc.default(t, Jr()).read(e);
      return;
    }
    new Pc.default(t, Jr(e)).read(r);
  }
  n(Lb, "walk");
  Ie.walk = Lb;
  function Fb(t, e) {
...
var ti = f((Js) => {
  ...
  var Bb = require("path"), Wb = dt(), Rc = Fe(), Zs = class {
    static {
      n(this, "Reader");
    }
    constructor(e) {
...
var rn = f((tn) => {
  ...
  var Vb = require("stream"), Gb = dt(), Ub = ei(), Yb = ti(), en = class extends Yb.default {
    static {
      n(this, "ReaderStream");
    }
    constructor() {
...
var Ac = f((nn) => {
  ...
  var zb = ei(), Kb = ti(), Xb = rn(), sn = class extends Kb.default {
    static {
      n(this, "ReaderAsync");
    }
    constructor() {
...
var Oc = f((hn) => {
  ...
  var ri = Fe(), Zb = Tc(), cn = class {
    ...
    _getNegativePatternsRe(e) {
      let r = e.filter(ri.pattern.isAffectDepthOfReadingPattern);
      return ri.pattern.convertPatternsToRe(r, this._micromatchOptions);
    }
    _filter(e, r, i, s) {
      if (this._isSkippedByDeep(e, r.path) || this._isSkippedSymbolicLink(r))
        return !1;
      let o = ri.path.removeLeadingDotSegment(r.path);
    ...
    _isSkippedByNegativePatterns(e, r) {
      return !ri.pattern.matchAny(e, r);
    }
  };
  hn.default = cn;
});
...
var Dc = f((dn) => {
  ...
  var it = Fe(), pn = class {
    ...
    getFilter(e, r) {
      let [i, s] = it.pattern.partitionAbsoluteAndRelative(r), o = {
        positive: {
        ...
        negative: {
          ...
          relative: it.pattern.convertPatternsToRe(s, Object.assign(Object.assign({}, this._micromatchOptions), { dot: !0 }))
        }
      };
    ...
    _isMatchToAbsoluteNegative(e, r, i) {
      if (r.length === 0)
        return !1;
      let s = it.path.makeAbsolute(this._settings.cwd, e);
      return this._isMatchToPatterns(s, r, i);
    }
    _isMatchToPatterns(e, r, i) {
      if (r.length === 0)
        return !1;
      let s = it.pattern.matchAny(e, r);
...
var Nc = f((vn) => {
  ...
  var n_ = Ac(), o_ = ii(), _n = class extends o_.default {
    static {
...
var Mc = f((wn) => {
  ...
  var a_ = require("stream"), l_ = rn(), u_ = ii(), Sn = class extends u_.default {
    static {
...
var qc = f((Pn) => {
  ...
  var c_ = dt(), h_ = ei(), p_ = ti(), En = class extends p_.default {
    static {
      n(this, "ReaderSync");
    }
    constructor() {
...
var jc = f((An) => {
  "use strict";
  Object.defineProperty(An, "__esModule", { value: !0 });
  var d_ = qc(), f_ = ii(), Rn = class extends f_.default {
    static {
      n(this, "ProviderSync");
    }
    constructor() {
...
var Lc = f((Tt) => {
  "use strict";
  Object.defineProperty(Tt, "__esModule", { value: !0 });
  Tt.DEFAULT_FILE_SYSTEM_ADAPTER = void 0;
  var Ct = require("fs"), m_ = require("os"), g_ = Math.max(m_.cpus().length, 1);
  Tt.DEFAULT_FILE_SYSTEM_ADAPTER = {
    lstat: Ct.lstat,
  ...
  var Cn = class {
    ...
    _getFileSystemMethods(e = {}) {
      return Object.assign(Object.assign({}, Tt.DEFAULT_FILE_SYSTEM_ADAPTER), e);
    }
  };
  Tt.default = Cn;
});
...
var In = f((cC, Hc) => {
  "use strict";
  var Fc = Hu(), y_ = Nc(), x_ = Mc(), b_ = jc(), Tn = Lc(), ge = Fe();
...
var Bc, Wc, pC, Vc, dC, fC, Gc, mC, Uc = de(() => {
  Bc = L(require("node:fs"), 1), Wc = L(require("node:fs/promises"), 1);
  n(kn, "isType");
  n($n, "isTypeSync");
  pC = kn.bind(void 0, "stat", "isFile"), Vc = kn.bind(void 0, "stat", "isDirectory"), dC = kn.bind(void 0, "lstat", "isSymbolicLink"), fC =
  $n.bind(void 0, "statSync", "isFile"), Gc = $n.bind(void 0, "statSync", "isDirectory"), mC = $n.bind(void 0, "lstatSync", "isSymbolicLink");
});
...
var ih = f((PC, Wn) => {
  ...
  () => !1, "RETURN_FALSE"), O_ = /* @__PURE__ */ n((t) => t.replace(
  ...
  ], k_ = /(^|\\\/)?\\\*$/, er = "regex", si = "checkRegex", Qc = "_", $_ = {
    [er](t, e) {
      return `${e ? `${e}[^/]+` : "[^/]*"}(?=$|\\/$)`;
    },
    [si](t, e) {
    ...
    t
  ), "makeRegexPrefix"), ni = /* @__PURE__ */ n((t) => typeof t == "string", "isString"), M_ = /* @__PURE__ */ n((t) => t && ni(t) && !S_.test(
  t) && !w_.test(t) && t.indexOf("#") !== 0, "checkPattern"), q_ = /* @__PURE__ */ n((t) => t.split(R_).filter(Boolean), "splitPattern"), Ln = class {
    ...
    get checkRegex() {
      let e = Qc + si;
      return this[e] ? this[e] : this._make(si, e);
    }
    _make(e, r) {
    ...
    throw new e(t);
  }, "throwError"), He = /* @__PURE__ */ n((t, e, r) => ni(t) ? t ? He.isNotRelative(t) ? r(
  ...
  var Hn = class {
    ...
    checkIgnore(e) {
      if (!C_.test(e))
        return this.test(e);
      let r = e.split(Ot).filter(Boolean);
      if (r.pop(), r.length) {
        let i = this._t(
          r.join(Ot) + Ot,
          this._testCache,
      ...
      return this._rules.test(e, !1, si);
    }
    _t(e, r, i, s) {
      if (e in r)
        return r[e];
      if (s || (s = e.split(Ot).filter(Boolean)), s.pop(), !s.length)
  ...
  }, Bn = /* @__PURE__ */ n((t) => new Hn(t), "factory"), F_ = /* @__PURE__ */ n((t) => He(t && He.convert(t), t, th), "isPathValid");
  if (
    ...
    He.convert = t;
    let e = /^[a-z]:\//i;
    He.isNotRelative = (r) => e.test(r) || rh(r);
  }
  Wn.exports = Bn;
  Bn.default = Bn;
...
var nh, oh, ah, ft, Gn, lh, H_, uh, oi, B_, W_, V_, ch, hh, rr, ir, ph, dh, Un = de(() => {
  nh = L(require("node:process"), 1), oh = L(require("node:fs"), 1), ah = L(require("node:fs/promises"), 1), ft = L(require("node:path"), 1),
  Gn = L(In(), 1), lh = L(ih(), 1);
  sh();
  Mn();
  Vn();
  H_ = [
    ...
    absolute: !0,
    dot: !0
  }, oi = "**/.gitignore", B_ = /* @__PURE__ */ n((t, e) => tr(t) ? "!" + ft.default.posix.join(e, t.slice(1)) : ft.default.posix.join(e, t),
  "applyBaseToPattern"), W_ = /* @__PURE__ */ n((t, e) => {
    let r = Dt(ft.default.relative(e, ft.default.dirname(t.filePath)));
    return t.content.split(/\r?\n/).filter((i) => i && !i.startsWith("#")).map((i) => B_(i, r));
  }, "parseIgnoreFile"), V_ = /* @__PURE__ */ n((t, e) => {
    if (e = Dt(e), ft.default.isAbsolute(t)) {
      if (Dt(t).startsWith(e))
    ...
    return (s) => (s = Zt(s), s = V_(s, e), s ? i.ignores(Dt(s)) : !1);
    ...
    return ch(l, r);
  }, "isIgnoredByIgnoreFilesSync"), ph = /* @__PURE__ */ n((t) => rr(oi, t), "isGitIgnored"), dh = /* @__PURE__ */ n((t) => ir(oi, t), "isGi\
tIgnoredSync");
});
...
var Yn, gh, mt, It, G_, yh, xh, fh, mh, zn, U_, bh, _h, ai, vh, Y_, Sh, wh, Eh, Ph, Rh, Ah, Kn, z_, K_, X_, Q_, Z_, J_, ev, Th = de(() => {
  Yn = L(require("node:process"), 1), gh = L(require("node:fs"), 1), mt = L(require("node:path"), 1);
  Za();
  It = L(In(), 1);
  Uc();
  Mn();
...
/*${i}` : ""}`)];
  ...
  (t) => (t = [...new Set([t].flat())], G_(t), t), "toPatternsArray"), U_ = /* @__PURE__ */ n((t) => {
    ...
    cwd: Zt(t.cwd)
  }, U_(t.cwd), t), "normalizeOptions"), _h = /* @__PURE__ */ n((t) => async (e, r) => t(zn(e), bh(r)), "normalizeArguments"), ai = /* @__PURE__ */ n(
  (t) => (e, r) => t(zn(e), bh(r)), "normalizeArgumentsSync"), vh = /* @__PURE__ */ n((t) => {
    let { ignoreFiles: e, gitignore: r } = t, i = e ? zn(e) : [];
    return r && i.push(oi), i;
    ...
    return (r) => {
      let i = mt.default.normalize(r.path ?? r);
  ...
  (t, e) => {
    ...
    let [
      ...
      Ah(t, e),
      Y_(e)
    ]), s = await Promise.all(r.map((o) => (0, It.default)(o.patterns, o.options)));
    return Eh(s, i);
  }), K_ = ai((t, e) => {
    let r = Kn(t, e), i = Sh(e), s = r.map((o) => It.default.sync(o.patterns, o.options));
    return Eh(s, i);
  }), X_ = ai((t, e) => {
    let r = Kn(t, e), i = Sh(e), s = r.map((a) => It.default.stream(a.patterns, a.options));
    return Yi(s).filter((a) => i(a));
  }), Q_ = ai(
    (t, e) => t.some((r) => It.default.isDynamicPattern(r, e))
  ), Z_ = _h(Ah), J_ = ai(Kn), { convertPathToPattern: ev } = It.default;
});

// ../node_modules/picocolors/picocolors.js
var Bh = f((dT, Xn) => {
  var fi = process || {}, Fh = fi.argv || [], di = fi.env || {}, nv = !(di.NO_COLOR || Fh.includes("--no-color")) && (!!di.FORCE_COLOR || Fh.
  includes("--color") || fi.platform === "win32" || (fi.stdout || {}).isTTY && di.TERM !== "dumb" || !!di.CI), ov = /* @__PURE__ */ n((t, e, r = t) => (i) => {
...
function Wh(t, e, r = "") {
  t = (0, Nt.resolve)(".", t);
  let i = (0, mi.readdirSync)(t), s = 0, o, a;
  for (; s < i.length; s++)
    o = (0, Nt.join)(t, i[s]), a = (0, mi.statSync)(o), a.isDirectory() ? Wh(o, e, (0, Nt.join)(r, i[s])) : e((0, Nt.join)(r, i[s]), o, a);
}
var Nt, mi, Gh = de(() => {
  Nt = require("path"), mi = require("fs");
  n(Wh, "totalist");
});
...
var tp = f((xT, ep) => {
  ...
  ep.exports = function(t, e = {}) {
    ...
    return function(g, _, P) {
      let E = [""], k = fv(g).pathname, T = g.headers["accept-encoding"] || "";
      if (o && T.includes("gzip") && E.unshift(...o), a && /(br|brotli)/i.test(T) && E.unshift(...a), E.push(...s), k.indexOf("%") !== -1)
        try {
          k = decodeURI(k);
        } catch {
        }
      let G = w(k, E) || h && !yv(k, m) && w(u, E);
      if (!G) return P ? P() : r(g, _);
      if (c && g.headers["if-none-match"] === G.headers.ETag)
        return _.writeHead(304), _.end();
      (o || a) && _.setHeader("Vary", "Accept-Encoding"), i(_, k, G.stats), vv(g, _, G.abs, G.stats, G.headers);
    };
  };
});
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  var Nv = gi(), dp = K(), pp = dp.erase, Mv = dp.cursor, qv = /* @__PURE__ */ n((t) => [...Nv(t)].length, "width");
...
var xp = f(($T, yp) => {
  "use strict";
  var Mt = Y(), gt = so(), no = Object.freeze({
    password: {
      scale: 1,
    ...
    aborted: Mt.red(gt.cross),
    done: Mt.green(gt.tick),
    exited: Mt.yellow(gt.cross),
    default: Mt.cyan("?")
  }), Hv = /* @__PURE__ */ n((t, e, r) => e ? lr.aborted : r ? lr.exited : t ? lr.done : lr.default, "symbol"), Bv = /* @__PURE__ */ n((t) => Mt.
  gray(t ? gt.ellipsis : gt.pointerSmall), "delimiter"), Wv = /* @__PURE__ */ n((t, e) => Mt.gray(t ? e ? gt.pointerSmall : "+" : gt.line), "\
item");
  yp.exports = {
    styles: no,
    render: Fv,
...
var Be = f((FT, Cp) => {
  "use strict";
  var Rp = require("readline"), Gv = we(), Uv = Gv.action, Yv = require("events"), Ap = K(), zv = Ap.beep, Kv = Ap.cursor, Xv = Y(), oo = class extends Yv {
    static {
      n(this, "Prompt");
    }
    constructor(e = {}) {
...
var kp = f((BT, Ip) => {
  ...
  var yi = Y(), Qv = Be(), Dp = K(), Zv = Dp.erase, ur = Dp.cursor, xi = we(), ao = xi.style, lo = xi.clear, Jv = xi.lines, eS = xi.figures,
  uo = class extends Qv {
    static {
      n(this, "TextPrompt");
    }
    ...
    set value(e) {
      !e && this.initial ? (this.placeholder = !0, this.rendered = yi.gray(this.transform.render(this.initial))) : (this.placeholder = !1, this.
...
`), e.close();
    ...
    render() {
      ...
      [ao.symbol(this.done, this.aborted), yi.bold(this.msg), ao.delimiter(this.done), this.red ? yi.red(this.rendered) : this.rendered].join(
      " "), this.error && (this.outputError += this.errorMsg.split(`
`).reduce((e, r, i) => e + `
${i ? " " : eS.pointerSmall} ${yi.red().italic(r)}`, "")), this.out.write(Zv.line + ur.to(0) + this.outputText + ur.save + this.outputError +
...
var qp = f((VT, Mp) => {
  "use strict";
  var We = Y(), tS = Be(), cr = we(), $p = cr.style, Np = cr.clear, bi = cr.figures, rS = cr.wrap, iS = cr.entriesToDisplay, sS = K(), nS = sS.
...
`), this.close());
    ...
    render() {
      ...
      if (this.outputText = [$p.symbol(this.done, this.aborted), We.bold(this.msg), $p.delimiter(!1), this.done ? this.selection.title : this.
      selection.disabled ? We.yellow(this.warn) : We.gray(this.hint)].join(" "), !this.done) {
        this.outputText += `
`;
        for (let s = r; s < i; s++) {
          let o, a, l = "", u = this.choices[s];
          s === r && r > 0 ? a = bi.arrowUp : s === i - 1 && i < this.choices.length ? a = bi.arrowDown : a = " ", u.disabled ? (o = this.cursor ===
          s ? We.gray().underline(u.title) : We.strikethrough().gray(u.title), a = (this.cursor === s ? We.bold().gray(bi.pointer) + " " : "\
  ") + a) : (o = this.cursor === s ? We.cyan().underline(u.title) : u.title, a = (this.cursor === s ? We.cyan(bi.pointer) + " " : "  ") + a,
...
var Wp = f((UT, Bp) => {
  "use strict";
  var _i = Y(), oS = Be(), Fp = we(), jp = Fp.style, aS = Fp.clear, Hp = K(), Lp = Hp.cursor, lS = Hp.erase, ho = class extends oS {
    static {
      n(this, "TogglePrompt");
    }
    constructor(e = {}) {
...
`), this.close();
    ...
    render() {
      ...
      outputText = [jp.symbol(this.done, this.aborted), _i.bold(this.msg), jp.delimiter(this.done), this.value ? this.inactive : _i.cyan().underline(
      this.inactive), _i.gray("/"), this.value ? _i.cyan().underline(this.active) : this.active].join(" "), this.out.write(lS.line + Lp.to(0) +
      this.outputText));
    }
  };
  Bp.exports = ho;
...
var zp = f((ZT, Yp) => {
  "use strict";
  var cS = ke(), hS = /* @__PURE__ */ n((t) => (t = t % 10, t === 1 ? "st" : t === 2 ? "nd" : t === 3 ? "rd" : "th"), "pos"), mo = class extends cS {
    static {
      n(this, "Day");
    }
    constructor(e = {}) {
...
var xd = f((dO, yd) => {
  ...
  var So = Y(), xS = Be(), Eo = we(), hd = Eo.style, pd = Eo.clear, bS = Eo.figures, gd = K(), _S = gd.erase, dd = gd.cursor, Ve = ld(), fd = Ve.
  DatePart, vS = Ve.Meridiem, SS = Ve.Day, wS = Ve.Hours, ES = Ve.Milliseconds, PS = Ve.Minutes, RS = Ve.Month, AS = Ve.Seconds, CS = Ve.Year,
...
var Pd = f((mO, Ed) => {
  ...
  var vi = Y(), DS = Be(), wd = K(), Si = wd.cursor, IS = wd.erase, wi = we(), Po = wi.style, kS = wi.figures, vd = wi.clear, $S = wi.lines,
...
`), e.close();
    ...
    render() {
      this.closed || (this.firstRender || (this.outputError && this.out.write(Si.down($S(this.outputError, this.out.columns) - 1) + vd(this.
      ...
      [Po.symbol(this.done, this.aborted), vi.bold(this.msg), Po.delimiter(this.done), !this.done || !this.done && !this.placeholder ? vi[this.
      color]().underline(this.rendered) : this.rendered].join(" "), this.error && (this.outputError += this.errorMsg.split(`
`).reduce((e, r, i) => e + `
${i ? " " : kS.pointerSmall} ${vi.red().italic(r)}`, "")), this.out.write(IS.line + Si.to(0) + this.outputText + Si.save + this.outputError +
      Si.restore));
    }
  };
  Ed.exports = Ao;
...
var To = f((yO, Cd) => {
  "use strict";
  var $e = Y(), MS = K(), qS = MS.cursor, jS = Be(), hr = we(), Rd = hr.clear, nt = hr.figures, Ad = hr.style, LS = hr.wrap, FS = hr.entriesToDisplay,
  Co = class extends jS {
    static {
...
`);
    ...
    render() {
      ...
      let e = [Ad.symbol(this.done, this.aborted), $e.bold(this.msg), Ad.delimiter(!1), this.renderDoneOrInstructions()].join(" ");
...
var Nd = f((bO, $d) => {
  ...
  var pr = Y(), BS = Be(), kd = K(), WS = kd.erase, Od = kd.cursor, dr = we(), Oo = dr.style, Dd = dr.clear, Do = dr.figures, VS = dr.wrap, GS = dr.
...
var Ld = f((vO, jd) => {
  "use strict";
  var Ge = Y(), zS = K(), KS = zS.cursor, XS = To(), $o = we(), Md = $o.clear, qd = $o.style, qt = $o.figures, ko = class extends XS {
    static {
...
`;
    ...
    renderOption(e, r, i) {
      let s;
      return r.disabled ? s = e === i ? Ge.gray().underline(r.title) : Ge.strikethrough().gray(r.title) : s = e === i ? Ge.cyan().underline(
      r.title) : r.title, (r.selected ? Ge.green(qt.radioOn) : qt.radioOff) + "  " + s;
    }
    renderDoneOrInstructions() {
      if (this.done)
        return this.value.filter((r) => r.selected).map((r) => r.title).join(", ");
      let e = [Ge.gray(this.hint), this.renderInstructions(), this.renderCurrentInput()];
      return this.filteredOptions.length && this.filteredOptions[this.cursor].disabled && e.push(Ge.yellow(this.warn)), e.join(" ");
    }
    render() {
      if (this.closed) return;
      this.firstRender && this.out.write(KS.hide), super.render();
      let e = [qd.symbol(this.done, this.aborted), Ge.bold(this.msg), qd.delimiter(!1), this.renderDoneOrInstructions()].join(" ");
      this.showMinError && (e += Ge.red(`You must select a minimum of ${this.minSelected} choices.`), this.showMinError = !1), e += this.renderOptions(
...
var Ud = f((wO, Gd) => {
  "use strict";
  var Fd = Y(), QS = Be(), Wd = we(), Hd = Wd.style, ZS = Wd.clear, Vd = K(), JS = Vd.erase, Bd = Vd.cursor, No = class extends QS {
    static {
...
var Xd = f((Kd) => {
  "use strict";
  var ae = Kd, ew = zd(), Ei = /* @__PURE__ */ n((t) => t, "noop");
  function Ne(t, e, r = {}) {
    return new Promise((i, s) => {
      let o = new ew[t](e), a = r.onAbort || Ei, l = r.onSubmit || Ei, u = r.onExit || Ei;
      o.on("state", e.onState || Ei), o.on("submit", (c) => i(l(c))), o.on("exit", (c) => i(u(c))), o.on("abort", (c) => s(a(c)));
    });
  }
  n(Ne, "toPrompt");
...
tle");
  ae.autocomplete = (t) => (t.suggest = t.suggest || tw, t.choices = [].concat(t.choices || []), Ne("AutocompletePrompt", t));
});
  ...
  function qo() {
    return qo = tf(function* (t = [], {
      ...
      let o, a, l, u, c, h, m = /* @__PURE__ */ function() {
        var P = tf(function* (E, k, T = !1) {
          if (!(!T && E.validate && E.validate(k) !== !0))
            return E.format ? yield E.format(k, i) : k;
        });
        return /* @__PURE__ */ n(function(k, T) {
      ...
      try {
        for (p.s(); !(w = p.n()).done; ) {
          ...
          if (u = g.name, c = g.type, typeof c == "function" && (c = yield c(o, Zd({}, i), a), a.type = c), !!c) {
            ...
            try {
              o = ot._injected ? ow(ot._injected, a.initial) : yield Mo[c](a), i[u] = o = yield m(a, o, !0), l = yield e(a, o, i);
            } catch {
              l = !(yield r(a, i));
            }
            if (l) return i;
...
var hf = f((IO, cf) => {
  "use strict";
  var uw = Pi(), { erase: uf, cursor: cw } = K(), hw = /* @__PURE__ */ n((t) => [...uw(t)].length, "width");
...
var ff = f((NO, df) => {
  "use strict";
  var jt = Y(), yt = jo(), Lo = Object.freeze({
    ...
    aborted: jt.red(yt.cross),
    done: jt.green(yt.tick),
    exited: jt.yellow(yt.cross),
    default: jt.cyan("?")
  }), mw = /* @__PURE__ */ n((t, e, r) => e ? mr.aborted : r ? mr.exited : t ? mr.done : mr.default, "symbol"), gw = /* @__PURE__ */ n((t) => jt.
  gray(t ? yt.ellipsis : yt.pointerSmall), "delimiter"), yw = /* @__PURE__ */ n((t, e) => jt.gray(t ? e ? yt.pointerSmall : "+" : yt.line), "\
item");
  df.exports = {
    styles: Lo,
    render: fw,
...
var Ue = f((HO, wf) => {
  "use strict";
  var Sf = require("readline"), { action: bw } = Ee(), _w = require("events"), { beep: vw, cursor: Sw } = K(), ww = Y(), Fo = class extends _w {
    static {
      n(this, "Prompt");
    }
    constructor(e = {}) {
...
var Pf = f((WO, Ef) => {
  var Ri = Y(), Ew = Ue(), { erase: Pw, cursor: gr } = K(), { style: Ho, clear: Bo, lines: Rw, figures: Aw } = Ee(), Wo = class extends Ew {
    static {
      n(this, "TextPrompt");
    }
    constructor(e = {}) {
    ...
    set value(e) {
      !e && this.initial ? (this.placeholder = !0, this.rendered = Ri.gray(this.transform.render(this.initial))) : (this.placeholder = !1, this.
      rendered = this.transform.render(e)), this._value = e, this.fire();
    }
    get value() {
      return this._value;
...
`), this.close();
    ...
    render() {
      ...
      [
        ...
        this.red ? Ri.red(this.rendered) : this.rendered
      ].join(" "), this.error && (this.outputError += this.errorMsg.split(`
`).reduce((e, r, i) => e + `
${i ? " " : Aw.pointerSmall} ${Ri.red().italic(r)}`, "")), this.out.write(Pw.line + gr.to(0) + this.outputText + gr.save + this.outputError +
...
var Tf = f((GO, Cf) => {
  "use strict";
  var Ye = Y(), Cw = Ue(), { style: Rf, clear: Af, figures: Ai, wrap: Tw, entriesToDisplay: Ow } = Ee(), { cursor: Dw } = K(), Vo = class extends Cw {
    static {
      n(this, "SelectPrompt");
    }
    constructor(e = {}) {
...
`), this.close());
    ...
    render() {
      ...
      if (this.outputText = [
        ...
        Ye.bold(this.msg),
        Rf.delimiter(!1),
        this.done ? this.selection.title : this.selection.disabled ? Ye.yellow(this.warn) : Ye.gray(this.hint)
      ].join(" "), !this.done) {
        this.outputText += `
`;
        for (let i = e; i < r; i++) {
          ...
          i ? Ye.gray().underline(l.title) : Ye.strikethrough().gray(l.title), o = (this.cursor === i ? Ye.bold().gray(Ai.pointer) + " " : "\
  ") + o) : (s = this.cursor === i ? Ye.cyan().underline(l.title) : l.title, o = (this.cursor === i ? Ye.cyan(Ai.pointer) + " " : "  ") + o,
          l.description && this.cursor === i && (a = ` - ${l.description}`, (o.length + s.length + a.length >= this.out.columns || l.description.
          split(/\r?\n/).length > 1) && (a = `
` + Tw(l.description, { margin: 3, width: this.out.columns })))), this.outputText += `${o} ${s}${Ye.gray(a)}
`;
        }
      }
      this.out.write(this.outputText);
...
var kf = f((YO, If) => {
  var Ci = Y(), Iw = Ue(), { style: Of, clear: kw } = Ee(), { cursor: Df, erase: $w } = K(), Go = class extends Iw {
    static {
      n(this, "TogglePrompt");
    }
    constructor(e = {}) {
...
`), this.close();
    ...
    render() {
      ...
      outputText = [
        ...
        this.value ? this.inactive : Ci.cyan().underline(this.inactive),
        Ci.gray("/"),
        this.value ? Ci.cyan().underline(this.active) : this.active
...
var jf = f((JO, qf) => {
  "use strict";
  var Mw = Me(), qw = /* @__PURE__ */ n((t) => (t = t % 10, t === 1 ? "st" : t === 2 ? "nd" : t === 3 ? "rd" : "th"), "pos"), zo = class extends Mw {
    static {
      n(this, "Day");
    }
    constructor(e = {}) {
...
var nm = f((f0, sm) => {
  "use strict";
  var ta = Y(), Vw = Ue(), { style: Jf, clear: em, figures: Gw } = Ee(), { erase: Uw, cursor: tm } = K(), { DatePart: rm, Meridiem: Yw, Day: zw,
...
var um = f((g0, lm) => {
  var Ti = Y(), iE = Ue(), { cursor: Oi, erase: sE } = K(), { style: ia, figures: nE, clear: om, lines: oE } = Ee(), aE = /[0-9]/, sa = /* @__PURE__ */ n(
...
`), this.close();
    ...
    render() {
      this.closed || (this.firstRender || (this.outputError && this.out.write(Oi.down(oE(this.outputError, this.out.columns) - 1) + om(this.
...
`).reduce((e, r, i) => e + `
${i ? " " : nE.pointerSmall} ${Ti.red().italic(r)}`, "")), this.out.write(sE.line + Oi.to(0) + this.outputText + Oi.save + this.outputError +
      Oi.restore));
    }
  };
  lm.exports = na;
...
var aa = f((x0, pm) => {
  "use strict";
  var qe = Y(), { cursor: lE } = K(), uE = Ue(), { clear: cm, figures: at, style: hm, wrap: cE, entriesToDisplay: hE } = Ee(), oa = class extends uE {
    static {
      n(this, "MultiselectPrompt");
    }
    constructor(e = {}) {
...
` : "") + "    enter/return: Complete answer" : "";
    ...
    renderOption(e, r, i, s) {
      let o = (r.selected ? qe.green(at.radioOn) : at.radioOff) + " " + s + " ", a, l;
      return r.disabled ? a = e === i ? qe.gray().underline(r.title) : qe.strikethrough().gray(r.title) : (a = e === i ? qe.cyan().underline(
      r.title) : r.title, e === i && r.description && (l = ` - ${r.description}`, (o.length + a.length + l.length >= this.out.columns || r.description.
      split(/\r?\n/).length > 1) && (l = `
` + cE(r.description, { margin: o.length, width: this.out.columns })))), o + a + qe.gray(l || "");
    }
    // shared with autocompleteMultiselect
    paginateOptions(e) {
      if (e.length === 0)
        return qe.red("No matches for this query.");
...
`);
    ...
    renderDoneOrInstructions() {
      if (this.done)
        return this.value.filter((r) => r.selected).map((r) => r.title).join(", ");
      let e = [qe.gray(this.hint), this.renderInstructions()];
      return this.value[this.cursor].disabled && e.push(qe.yellow(this.warn)), e.join(" ");
    }
    render() {
      if (this.closed) return;
...
var ym = f((_0, gm) => {
  "use strict";
  var yr = Y(), pE = Ue(), { erase: dE, cursor: dm } = K(), { style: la, clear: fm, figures: ua, wrap: fE, entriesToDisplay: mE } = Ee(), mm = /* @__PURE__ */ n(
...
var vm = f((S0, _m) => {
  "use strict";
  var ze = Y(), { cursor: xE } = K(), bE = aa(), { clear: xm, style: bm, figures: Lt } = Ee(), ha = class extends bE {
    static {
      n(this, "AutocompleteMultiselectPrompt");
    }
    constructor(e = {}) {
...
`;
    ...
    renderOption(e, r, i) {
      let s;
      return r.disabled ? s = e === i ? ze.gray().underline(r.title) : ze.strikethrough().gray(r.title) : s = e === i ? ze.cyan().underline(
      r.title) : r.title, (r.selected ? ze.green(Lt.radioOn) : Lt.radioOff) + "  " + s;
    }
    renderDoneOrInstructions() {
      if (this.done)
        return this.value.filter((r) => r.selected).map((r) => r.title).join(", ");
...
var Rm = f((E0, Pm) => {
  var Sm = Y(), _E = Ue(), { style: wm, clear: vE } = Ee(), { erase: SE, cursor: Em } = K(), pa = class extends _E {
    static {
      n(this, "ConfirmPrompt");
    }
    constructor(e = {}) {
...
var Om = f((Tm) => {
  "use strict";
  var le = Tm, wE = Cm(), Di = /* @__PURE__ */ n((t) => t, "noop");
  function je(t, e, r = {}) {
    return new Promise((i, s) => {
      let o = new wE[t](e), a = r.onAbort || Di, l = r.onSubmit || Di, u = r.onExit || Di;
      o.on("state", e.onState || Di), o.on("submit", (c) => i(l(c))), o.on("exit", (c) => i(u(c))), o.on("abort", (c) => s(a(c)));
    });
  }
  n(je, "toPrompt");
  le.text = (t) => je("TextPrompt", t);
  le.password = (t) => (t.style = "password", le.text(t));
  le.invisible = (t) => (t.style = "invisible", le.text(t));
  le.number = (t) => je("NumberPrompt", t);
  le.date = (t) => je("DatePrompt", t);
  le.confirm = (t) => je("ConfirmPrompt", t);
  le.list = (t) => {
    let e = t.separator || ",";
  ...
  le.toggle = (t) => je("TogglePrompt", t);
  le.select = (t) => je("SelectPrompt", t);
  le.multiselect = (t) => {
    t.choices = [].concat(t.choices || []);
    let e = /* @__PURE__ */ n((r) => r.filter((i) => i.selected).map((i) => i.value), "toSelected");
  ...
  le.autocomplete = (t) => (t.suggest = t.suggest || EE, t.choices = [].concat(t.choices || []), je("AutocompletePrompt", t));
});
...
var km = f((T0, Im) => {
  ...
  async function lt(t = [], { onSubmit: e = Dm, onCancel: r = Dm } = {}) {
    ...
    for (a of t)
      if ({ name: u, type: c } = a, typeof c == "function" && (c = await c(o, { ...i }, a), a.type = c), !!c) {
        ...
        try {
          o = lt._injected ? RE(lt._injected, a.initial) : await da[c](a), i[u] = o = await m(a, o, !0), l = await e(a, o, i);
        } catch {
          l = !await r(a, i);
        }
        if (l) return i;
  ...
  n(CE, "override");
  Im.exports = Object.assign(lt, { prompt: lt, prompts: da, inject: AE, override: CE });
});
...
var $i = require("node:fs"), Hm = require("node:fs/promises"), pe = require("node:path"), Re = require("storybook/internal/common"), Bm = require("storybook/internal/csf-tools"),
Wm = require("storybook/internal/node-logger"), Vm = require("storybook/internal/telemetry"), Gm = L(ct(), 1);

// src/core-server/server-channel/create-new-story-channel.ts
var Fa = require("node:fs"), Ha = require("node:fs/promises"), Bi = require("node:path"), Ba = require("storybook/internal/common"), St = require("storybook/internal/core-events"),
Pr = require("storybook/internal/telemetry");

// src/core-server/utils/get-new-story-file.ts
var Ut = require("node:fs"), qa = require("node:fs/promises"), ee = require("node:path"), Xe = require("storybook/internal/common"), ja = require("storybook/internal/csf-tools");

// src/csf-tools/ConfigFile.ts
var ba = require("node:fs/promises"), d = require("storybook/internal/babel"), _a = L(ct(), 1);
var Mi = console, qi = /* @__PURE__ */ n(({
  expectedType: t,
  foundType: e,
  node: r
}) => _a.dedent`
...
t.key.value : null, "propKey"), wr = /* @__PURE__ */ n((t) => d.types.isTSAsExpression(t) || d.types.isTSSatisfiesExpression(t) ? wr(t.expression) :
t, "unwrap"), va = /* @__PURE__ */ n((t, e) => {
...
}, "_getPathProperties"), Er = /* @__PURE__ */ n((t, e) => {
  let r = null, i = null;
  ...
  id.name === t ? (r = o, !0) : !1))), r;
}, "_findVarDeclarator"), bt = /* @__PURE__ */ n((t, e) => Er(t, e)?.init, "_findVarInitialization"), Gt = /* @__PURE__ */ n((t, e) => {
  if (t.length === 0)
    return e;
  let [r, ...i] = t, s = Gt(i, e);
    ...
    return (0, d.traverse)(this._ast, {
      ExportDefaultDeclaration: {
        enter({ node: r, parent: i }) {
          ...
          s = wr(s), d.types.isCallExpression(s) && d.types.isObjectExpression(s.arguments[0]) && (s = s.arguments[0]), d.types.isObjectExpression(
          s) ? e._parseExportsObject(s) : Mi.warn(
            qi({
        ...
        enter({ node: r, parent: i }) {
          if (d.types.isVariableDeclaration(r.declaration))
            ...
            if (d.types.isExportSpecifier(s) && d.types.isIdentifier(s.local) && d.types.isIdentifier(s.exported)) {
              let { name: o } = s.local, { name: a } = s.exported, l = Er(o, i);
        ...
        enter({ node: r, parent: i }) {
          if (d.types.isAssignmentExpression(r.expression) && r.expression.operator === "=") {
            ...
            s.property.name === "exports") {
              let a = o;
              d.types.isIdentifier(o) && (a = bt(o.name, i)), a = wr(a), d.types.isObjectExpression(a) ? (e._exportsObject = a, a.properties.
              forEach((l) => {
                let u = _t(l);
                if (u) {
                  let c = l.value;
  ...
  setFieldNode(e, r) {
    ...
    if (this._exportsObject) {
      ...
      if (u && d.types.isIdentifier(u.value)) {
        let c = Er(u.value.name, this._ast.program);
    ...
    if (e.length === 1) {
      ...
      if (this._ast.program.body.forEach((o) => {
        ...
        if (d.types.isExportDefaultDeclaration(o)) {
          let a = o.declaration;
          if (d.types.isIdentifier(a) && (a = bt(a.name, this._ast.program)), a = wr(a), d.types.isObjectExpression(a)) {
            let l = a.properties;
            r(l, e[0]), s = !0;
          }
        }
...
var vt = /* @__PURE__ */ n(async (t) => (await Promise.resolve().then(() => (Oa(), Ta))).default(t.replace(/^[^a-zA-Z_$]*/, ""), { pascalCase: !0 }).
...
async function La({
  ...
  c = (0, ee.extname)(t), h = u.replace(c, ""), m = (0, ee.dirname)(t), { storyFileName: p, isTypescript: w, storyFileExtension: g } = Fi(t),
  _ = `${p}.${g}`, P = `${h}.${e}.stories.${g}`, E = "Default", k = !1;
  try {
    let A = (0, Xe.findConfigFile)("preview", s.configDir);
    if (A) {
      let $ = await (0, qa.readFile)(A, "utf-8");
      k = (0, ja.isCsfFactoryPreview)(wa($));
    }
  } catch {
  }
  let T = "";
  return k ? T = await Ia({
    ...
    componentIsDefaultExport: r,
    exportedStoryName: E
  }), { storyFilePath: Hi((0, ee.join)(o, m), p) && i > 1 ? (0, ee.join)(o, m, P) : (0, ee.join)(o, m, _), exportedStoryName: E, storyFileContent: T,
  dirname: ee.dirname };
}
    ...
    async (i) => {
      try {
        ...
        if ((0, Fa.existsSync)(s)) {
          ...
          }), r.disableTelemetry || (0, Pr.telemetry)("create-new-story-file", {
            success: !1,
            error: "STORY_FILE_EXISTS"
          });
          return;
        }
        await (0, Ha.writeFile)(s, a, "utf-8"), t.emit(St.CREATE_NEW_STORYFILE_RESPONSE, {
          success: !0,
          id: i.id,
          payload: {
            storyId: u,
        ...
        t.emit(St.CREATE_NEW_STORYFILE_RESPONSE, {
          ...
          id: i.id,
          error: s?.message
        }), r.disableTelemetry || await (0, Pr.telemetry)("create-new-story-file", {
          success: !1,
          error: s
        });
      }
...
var Dh = require("node:fs/promises"), kt = require("node:path"), $t = require("storybook/internal/common"), sr = require("storybook/internal/core-events"),
li = require("storybook/internal/telemetry");
  ...
  return t.on(
    ...
    async (i) => {
      ...
      try {
        if (!s)
          return;
        let o = await (0, $t.getFrameworkName)(e), a = await (0, $t.extractProperRendererNameFromFramework)(
          o
        ), l = (0, $t.getProjectRoot)(), c = (await Oh({
          searchQuery: s,
          cwd: l
        })).map(async (h) => {
          let m = Va(a);
          try {
            let p = await (0, Dh.readFile)((0, kt.join)(l, h), "utf-8"), { storyFileName: w } = Fi((0, kt.join)(l, h)), g = (0, kt.dirname)(
            h), _ = Hi((0, kt.join)(l, g), w), P = await m.parse(p);
            return {
              filepath: h,
            ...
            return r.disableTelemetry || (0, li.telemetry)("create-new-story-file-search", {
              success: !1,
        ...
        r.disableTelemetry || (0, li.telemetry)("create-new-story-file-search", {
          success: !0,
          payload: {
            fileCount: c.length
          }
...
var Mh = require("node:fs/promises"), hi = require("node:path"), qh = require("storybook/internal/common"), st = require("storybook/internal/core-events"),
nr = require("storybook/internal/csf"), pi = require("storybook/internal/csf-tools"), jh = require("storybook/internal/node-logger"), or = require("storybook/internal/telemetry");
...
var $h = /* @__PURE__ */ n((t, e, r) => {
  let i = t._storyExports[e], s = xe.types.cloneNode(i);
  if (!s)
  ...
  init.callee.property.name === "story") && (xe.types.isArrowFunctionExpression(s.init) || xe.types.isCallExpression(s.init)))
    throw new ye("Creating a new story based on a CSF2 story is not supported");
  return (0, xe.traverse)(t._ast, {
    Program(l) {
      l.pushContainer(
        "body",
        xe.types.exportNamedDeclaration(xe.types.variableDeclaration("const", [s]))
      );
    }
  }), s;
...
function ci(t) {
  ...
  switch (typeof t) {
    ...
    default:
      return Array.isArray(t) ? be.types.arrayExpression(t.map(ci)) : be.types.objectExpression(
        Object.keys(t).filter((r) => typeof t[r] < "u").map((r) => {
          let i = t[r];
          return be.types.objectProperty(be.types.stringLiteral(r), ci(i));
        })
      );
  }
}
...
var Nh = /* @__PURE__ */ n(async (t, e) => {
  let r = !1, i = Object.fromEntries(
    Object.entries(e).map(([o, a]) => [o, ci(a)])
  );
...
function Lh(t, e, r) {
  t.on(st.SAVE_STORY_REQUEST, async ({ id: i, payload: s }) => {
    ...
    try {
      m = (0, hi.basename)(a), p = (0, hi.join)(process.cwd(), a);
      let g = await (0, pi.readCsf)(p, {
      ...
      let [T] = P.find(([$, O]) => O.id.endsWith(`--${k}`)) || [];
      if (!T)
        throw new ye("Source story not found.");
      if (u && g.getStoryExport(u))
        throw new ye("Story already exists.");
      w = (0, nr.storyNameFromExport)(T), await Nh(
        u ? $h(_, T, u) : g.getStoryExport(T),
        l ? iv(l) : {}
      );
      let G = await (0, qh.formatFileContent)(
        p,
        sv((0, pi.printCsf)(g).code, u || T)
      );
      await Promise.all([
        new Promise(($) => {
          t.on(st.STORY_RENDERED, $), setTimeout(() => $(t.off(st.STORY_RENDERED, $)), 3e3);
        }),
        (0, Mh.writeFile)(p, G)
      ...
      let A = (0, or.isExampleStoryId)(c ?? o);
      !r.disableTelemetry && !A && await (0, or.telemetry)("save-story", {
      ...
      t.emit(st.SAVE_STORY_RESPONSE, {
        id: i,
        success: !1,
        error: g instanceof ye ? g.message : "Unknown error"
      }), jh.logger.error(
        `Error writing to ${p}:
${g.stack || g.message || g.toString()}`
      ), !r.disableTelemetry && !(g instanceof ye) && await (0, or.telemetry)("save-story", {
        action: u ? "createStory" : "updateStory",
        success: !1,
        error: g
      });
...
var Zn = require("node:fs"), Se = require("node:path"), Jn = require("storybook/internal/common"), wv = require("storybook/internal/node-logger"),
rp = L(Bh(), 1), Ev = L(tp(), 1), ip = L(ct(), 1);
var _T = (0, Jn.resolvePathInStorybookCache)("", "ignored-sub").split("ignored-sub")[0];
var sp = /* @__PURE__ */ n((t) => {
...
var qm = require("node:fs/promises"), Ii = require("storybook/internal/common"), Pe = require("storybook/internal/core-events"), ki = require("storybook/internal/csf-tools"),
...
var Ft = require("storybook/internal/common"), OE = require("storybook/internal/node-logger"), Ht = require("storybook/internal/telemetry"),
Mm = L(Nm(), 1);
    ...
    try {
      let i = await fetch(kE).then(async (u) => {
        if (u.ok)
          return u.json();
        throw u;
      }), o = (await (0, Ii.loadMainConfig)({ configDir: e.configDir, noCache: !0 })).core?.disableWhatsNewNotifications === !0, a = await e.
      cache.get(ma) ?? {}, l = {
        ...i,
        status: "SUCCESS",
      ...
      ga.logger.verbose(i instanceof Error ? i.message : String(i)), t.emit(Pe.RESULT_WHATS_NEW_DATA, {
        data: { status: "ERROR" }
      });
    }
  }), t.on(
    Pe.TOGGLE_WHATS_NEW_NOTIFICATIONS,
    async ({ disableWhatsNewNotifications: i }) => {
      let s = r.disableTelemetry !== !0;
      try {
        let o = (0, Ii.findConfigFile)("main", e.configDir);
        to(o, `unable to find Storybook main file in ${e.configDir}`);
        let a = await (0, ki.readConfig)(o);
        if (!a._exportsObject)
          throw new Error(
            "Unable to parse Storybook main file while trying to read 'core' property"
          );
        a.setFieldValue(["core", "disableWhatsNewNotifications"], i), await (0, qm.writeFile)(o, (0, ki.printConfig)(a).code), s && await (0, jm.telemetry)(
...
}, "previewHead"), HE = /* @__PURE__ */ n(async () => (0, Re.loadEnvs)({ production: !0 }).raw, "env"), BE = /* @__PURE__ */ n(async (t, { configDir: e,
presets: r }) => {
  let i = await r.apply("env");
  ...
  return e.disableTelemetry || (r = /* @__PURE__ */ n(async (i, s) => (await (0, Vm.telemetry)("remove", { addon: i, source: "api" }), (0, Re.removeAddon)(
