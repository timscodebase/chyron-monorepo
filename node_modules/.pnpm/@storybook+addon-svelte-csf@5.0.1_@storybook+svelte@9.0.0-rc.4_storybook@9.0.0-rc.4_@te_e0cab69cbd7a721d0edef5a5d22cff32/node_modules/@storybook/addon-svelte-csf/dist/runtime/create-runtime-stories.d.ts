 ...
 */
export declare const createRuntimeStories: (Stories: Component, meta: ComponentAnnotations<Cmp>) => Record<string, import("@storybook/core/csf").StoryAnnotations<import("@storybook/svelte").SvelteRenderer<import("svelte").SvelteComponent<Record<string, any>, any, any>>, Component<{
    Stories: Component;
    exportName: string;
